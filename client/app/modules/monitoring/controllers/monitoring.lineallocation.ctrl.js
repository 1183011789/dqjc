(function() {
    ...
    angular
        ...
        .controller('LineAllocationCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, Monitoring, Rode, $location) {
            console.log("线路分配----------");
            Monitoring.find({}).$promise.then(function(value) {
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        monitoringId: $scope.warningPostsArray[0]
                    }
