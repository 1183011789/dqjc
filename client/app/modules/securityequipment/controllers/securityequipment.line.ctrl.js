(function() {
    ...
    angular
        ...
        .controller('LineAllocationCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, SecurityEquipmentInformation, Rode, $location) {
            console.log("线路分配----------");
            SecurityEquipmentInformation.find({}).$promise.then(function(value) {
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        securityEquipmentInformationId: $scope.warningPostsArray[0]
                    }
            ...
            $scope.selectRow = function(warningpost) {
                    ...
                    RodeContain.find({
                        filter: {
                            ...
                            where: {
                                securityEquipmentInformationId: warningpost.id
                            }
                        }
                    }, function(result) {
