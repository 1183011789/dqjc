(function() {
    ...
    angular
        ...
        .controller('LineAllocationCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, KeyPersion, Rode, $location) {
            console.log("线路分配----------");
            KeyPersion.find({}).$promise.then(function(value) {
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        keyPersionId: $scope.warningPostsArray[0]
                    }
