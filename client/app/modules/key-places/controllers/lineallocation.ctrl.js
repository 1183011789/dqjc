(function() {
    ...
    angular
        ...
        .controller('LineAllocationCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, KeyPlace, Rode, $location) {
            console.log("线路分配----------");
            KeyPlace.find({}).$promise.then(function(value) {
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        keyPlaceId: $scope.warningPostsArray[0]
                    }
