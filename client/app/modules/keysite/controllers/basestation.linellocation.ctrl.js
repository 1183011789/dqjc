(function() {
    ...
    angular
        ...
        .controller('BlineCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, BaseStation, Rode, $location) {
            console.log("线路分配----------");
            BaseStation.find({}).$promise.then(function(value) {
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        baseStationId: $scope.warningPostsArray[0]
                    }
