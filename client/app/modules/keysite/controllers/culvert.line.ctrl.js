(function() {
    ...
    angular
        ...
        .controller('CulineCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, Culvert, Rode, $location) {
            console.log("线路分配----------");
            Culvert.find({}).$promise.then(function(value) {
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        culvertId: $scope.warningPostsArray[0]
                    }
