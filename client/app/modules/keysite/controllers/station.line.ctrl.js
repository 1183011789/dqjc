(function() {
    ...
    angular
        ...
        .controller('StlineCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, Station, Rode, $location) {
            console.log("线路分配----------");
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        stationId: $scope.warningPostsArray[0]
                    }
