(function() {
    ...
    angular
        ...
        .controller('BrlineCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, Bridge, Rode, $location) {
            console.log("线路分配----------");
            Bridge.find({}).$promise.then(function(value) {
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        bridgeId: $scope.warningPostsArray[0]
                    }
