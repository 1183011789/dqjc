(function() {
    ...
    angular
        ...
        .controller('LlineCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, LevelCrossing, Rode, $location) {
            console.log("线路分配----------");
            LevelCrossing.find({}).$promise.then(function(value) {
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        levelCrossingId: $scope.warningPostsArray[0]
                    }
            ...
            $scope.selectRow = function(warningpost) {
                    ...
                    RodeContain.find({
                        filter: {
                            ...
                            where: {
                                levelCrossingId: warningpost.id
                            }
                        }
                    }, function(result) {
