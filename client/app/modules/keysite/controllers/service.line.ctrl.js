(function() {
    ...
    angular
        ...
        .controller('SlineCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, ServicePort, Rode, $location) {
            console.log("线路分配----------");
            ServicePort.find({}).$promise.then(function(value) {
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        servicePortId: $scope.warningPostsArray[0]
                    }
