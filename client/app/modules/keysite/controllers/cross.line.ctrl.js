(function() {
    ...
    angular
        ...
        .controller('ClineCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, CrossIronBridge, Rode, $location) {
            console.log("线路分配----------");
            CrossIronBridge.find({}).$promise.then(function(value) {
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        crossIronBridgeId: $scope.warningPostsArray[0]
                    }
            ...
            $scope.selectRow = function(warningpost) {
                    ...
                    RodeContain.find({
                        filter: {
                            ...
                            where: {
                                crossIronBridgeId: warningpost.id
                            }
                        }
                    }, function(result) {
