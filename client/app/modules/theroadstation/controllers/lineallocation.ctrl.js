(function() {
    ...
    angular
        ...
        .controller('LineAllocationCtrl', function($scope, $state, CoreService, RodeContain, $rootScope, TheRoadStation, Rode, $location) {
            console.log("线路分配----------");
            TheRoadStation.find({}).$promise.then(function(value) {
            ...
            $scope.addEditItem = function(item) {
                ...
                if (item.checked) {
                    ...
                    var objs = {
                        ...
                        theRoadStationId: $scope.warningPostsArray[0]
                    }
            ...
            $scope.selectRow = function(warningpost) {
                    ...
                    RodeContain.find({
                        filter: {
                            ...
                            where: {
                                theRoadStationId: warningpost.id
                            }
                        }
                    }, function(result) {
