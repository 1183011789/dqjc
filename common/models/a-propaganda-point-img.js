...
// */
// Apropagandapointimg.uploadAvatar = function(imgKey, imgName, imgType, cb) {
//   // console.log(userId, imgKey, imgName, imgType);
//   var ImageModel = this.app.models.Apropagandapointimg;
...
//     // console.log('---------------set-----------------')
//     Apropagandapointimg.create(image, function(err, back) {
//       cb(err,back);
//     });
//   //});
// };
//
// Apropagandapointimg.remoteMethod('uploadAvatar', {
//   accepts: [
//     {
//       arg: 'imgKey',
//       type: 'string',
...
Apropagandapointimg.upload = function(ctx, options, cb) {
  options = options || {};
   ...
   */
  Apropagandapointimg.app.models.Container.upload(ctx.req, ctx.result,
    options, function(err, fileObj) {
      if (err) {
        ...
        Apropagandapointimg.create(objs, function(err, instances) {
          if (err) {
            return cb(null, {
              message: err.message,
            });
...
Apropagandapointimg.remoteMethod(
'upload',
  {
